...
@TeleOp(name="MaristBot2022: Teleop Quad 2022", group="Training")
//@Disabled
public class TeleopTank_Quad_2022 extends OpMode {
    ...
    public void loop() {
        ...
        robot.leftRear.setPower(left);
        robot.rightRear.setPower(right);
