...
@Autonomous(name = "ColorSensorTesting")
...
public class Autonomous_ColorSensor extends LinearOpMode {
  ...
  protected void runSample() {
    ...
    float gain = 1; // don't want to screw with telemetry so this is unused for now (also competitions are bright anyway)
    ...
    // use robot.color instead, perhaps?
